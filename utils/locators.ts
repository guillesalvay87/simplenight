export const LOCATORS = {
  HomePage: {
    hotelsTab: 'category-search-bar-tab(static_hotels)',
  },

  HotelsPage: {
    locationTrigger: 'category(static_hotels)_search-form_location_trigger',
    locationInput: 'category(static_hotels)_search-form_location_input',

    calendar: 'category(static_hotels)_search-form_dates_trigger',
    monthNext: '[data-direction="next"]',
    checkIn: 'category(static_hotels)_search-form_dates_calendar_day(2026-5-20)',
    checkOut: 'category(static_hotels)_search-form_dates_calendar_day(2026-5-22)',
    calendarDone: 'category(static_hotels)_search-form_dates_apply-button',

    guestsButton: 'category(static_hotels)_search-form_guests_trigger',
  ...
  SearchResultsPage: {
    gridViewButton: 'category(static_hotels)_search-results_layout-select_trigger',
    mapViewButton: 'category(static_hotels)_search-results_layout-select_option(map)',
